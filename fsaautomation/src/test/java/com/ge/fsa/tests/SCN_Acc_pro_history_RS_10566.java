...
public class SCN_Acc_pro_history_RS_10566 extends BaseLib {
	...
	public void Acc_pro_history_RS_10566() throws Exception {
		...
		String sFieldServiceName2 = GenericLib.getExcelData(sTestCaseID,sSheetName, "EditProcessName");
			...
			workOrderPo.navigateToWOSFM(commonsPo, exploreSearchPo, sExploreSearch, sExploreChildSearchTxt, WOname1, null);
			Thread.sleep(GenericLib.iMedSleep);
			...
			workOrderPo.selectAction(commonsPo, sFieldServiceName2);
			Thread.sleep(GenericLib.iLowSleep);
			commonsPo.tap(workOrderPo.getEleSaveLnk());
			Thread.sleep(GenericLib.iMedSleep);
			
			workOrderPo.navigateToWOSFM(commonsPo, exploreSearchPo, sExploreSearch, sExploreChildSearchTxt, WOname2, null);
			...
			workOrderPo.navigateToWOSFM(commonsPo, exploreSearchPo, sExploreSearch, sExploreChildSearchTxt, WOname3, null);
