...
public class Ph_SCN_CreateNewRecord_RS_10570 extends BaseLib{
	...
	public void RS_10570Test() throws Exception {
		...
		if(Integer.parseInt(sAccCount)==0) {
			...
			ExtentManager.logger.log(Status.INFO, "Account has been created through rest web service with Name:"+sAccountName+" and returned Account Id:"+sAccId);
			// Create Contact
			String sConId = restServices.restCreate("Contact?","{\"FirstName\": \"Stuart\", \"LastName\": \"Law\", \"AccountId\": \""+sAccId+"\"}");
			ExtentManager.logger.log(Status.INFO, "Contact has been created through rest web service with Account Id:"+sAccId+" Contact Id:"+sConId);
		}
