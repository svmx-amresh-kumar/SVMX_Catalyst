	...
	/*	
		...
		*/
		...
		ph_WorkOrderPo.createInstalledProduct(commonUtility,ph_CalendarPo,"AUTO11042019131130account", "AUTO11042019131130product",sInstalledproductID,ph_ExploreSearchPo);
		  ...
		  commonUtility.custScrollToElementAndClick(ph_WorkOrderPo.getElePartLnk(), "PART");
			Thread.sleep(4000);
			...
			commonUtility.custScrollToElementAndClick(ph_WorkOrderPo.getEleLaborLnk(),"LABOR");
