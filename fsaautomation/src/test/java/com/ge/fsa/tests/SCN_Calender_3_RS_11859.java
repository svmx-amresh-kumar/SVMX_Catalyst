...
//String sproductname = "Proforma30082018102823product";
	...
	//read from file
		...
		/*
		 * //Pre Login to app loginHomePo.login(commonsPo, exploreSearchPo);
		 * 
		 * //config sync toolsPo.configSync(commonsPo);
		 * Thread.sleep(GenericLib.iMedSleep);
		 * 
		 * 
		 * //Data Sync for WO's created toolsPo.syncData(commonsPo);
		 * Thread.sleep(GenericLib.iMedSleep);
		 * 
		 * /////////////////////////////////////////////////////////////////////////////
		 * //////////////////////////////////////////////// //verify WO event is present
		 * or not commonsPo.tap(calendarPO.getEleCalendarClick()); Thread.sleep(3000);
		 ...
		 * now1.set(Calendar.MINUTE, 0); now1.set(Calendar.SECOND, 0); String
		 * endtimezero=sdf.format(now1.getTime()); // now1.set(Calendar.HOUR_OF_DAY,
		 * 14); System.out.println(endtimezero);
		 * 
		 ...
		 * commonsPo.Enablepencilicon(calendarPO.getelegetsubject(sWO_SFDC_1)); //tap on
		 * pencil icon System.out.println("tap on pencil icon");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	try {commonsPo.tap(workOrderPo.getEleSaveLnk());
      ...
      sObjectApi = "Event";
		 ...
		 * System.out.println(errormsg); //Assert.assertEquals(
		 * errormsg,"An event can't last longer than 14 days.: Duration");
