	...
	public void preReqSetup(GenericLib genericLib) throws Exception {
	  ...
	  */
		...
		public void injectJenkinsPropertiesForSahi() {
			...
			try {
				this.writeTextFile(sFilePath,"var $jenkinsProp_config = new function jenkinsProp_config() { this.$catalyst_orgtype = "+System.getenv("Org_Type")+"; this.$catalyst_appiumOrg = "+System.getenv("Select_Config_Properties_For_Build")+";}");
