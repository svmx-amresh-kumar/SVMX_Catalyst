...
public class Ph_WorkOrderPO extends BaseLib {
	...
	@FindAll({ @FindBy(xpath = "//*[@text='Save']"), @FindBy(xpath = "(//XCUIElementTypeOther[@name=\"Save\"])[3]") })
	...
	@FindAll({ @FindBy(xpath = "//*[@text=''][1]"), @FindBy(xpath = "(//XCUIElementTypeOther[@name=\"\"])[1]") })
	...
	public WebElement getElelaborpartresult(String sProductName1) {
		...
		case "android":
			elelaborpartresult = driver
					.findElement(By.xpath("//*[@text='" + sProductName1 + "'][@class='android.widget.TextView']"));
			return elelaborpartresult;
		case "ios":
			return elelaborpartresult = driver.findElement(By.xpath(
					"(//XCUIElementTypeOther[@name=\" RESULTS\"])[3]/XCUIElementTypeOther[2]/XCUIElementTypeOther"));
		}
		return elelaborpartresult;
	...
	public void navigateToWOSFM(Ph_ExploreSearchPO ph_ExploreSearchPO, String sExploreSearch,
			String sExploreChildSearchTxt, String sWOName, String sFieldServiceName, CommonUtility commonUtility)
			throws InterruptedException {
		try {
	...
	public void createInstalledProduct(CommonUtility commonsUtility, Ph_CalendarPO ph_CalendarPo, String accountName,
	...
	public WebElement getChildLineAddItem(String value) {
		return driver.findElement(By.xpath(
				"//*[./*[@class='android.widget.TextView'][@text='" + value + "']][@class='android.view.ViewGroup']"));
	}

	public WebElement getChildLineAddedItem(String value) {
		return driver.findElement(
				By.xpath("(//*[.//*[contains(@text,'" + value + "')]][@class='android.widget.ScrollView'])[last()]"));
	}
	...
	public WebElement getEleChildLineItem(String childLine) {
		return driver.findElement(By
				.xpath("(//*[.//*[contains(@text,'" + childLine + "')]][@class='android.widget.ScrollView'])[last()]"));
	}
	...
	public void addExpense(CommonUtility commonsUtility, String sExpenseType, String sLineQty, String slinepriceperunit)
		...
		// commonsUtility.custScrollToElementAndClick(getChildLineAddItem("Add
		// Expense"));
