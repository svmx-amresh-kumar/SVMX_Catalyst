var MapInfoBox = MapInfoBox || {};
(function() {
  MapInfoBox.initialize = () => {
    if (MapInfoBox._initialized) return MapInfoBox.InfoBox;
    ...
    InfoBox.prototype.open = function(map, anchor) {
      ...
      if (anchor) {
        ...
        this._anchor = anchor;
        this._anchor_icon = anchor.getIcon();

        anchor.setIcon(
          'modules/com.servicemax.client.ui.modern.themes.orange/resources/theme-orange/images/map-pins/currentpin@1x.png'
        );
      }
    ...
    InfoBox.prototype.close = function() {
      ...
      if (this._anchor) {
        this._anchor.setIcon(this._anchor_icon);
        this._anchor = null;
      }
    ...
    InfoBox.prototype.getDom = function() {
      return this.div_ || null;
    };

    MapInfoBox.InfoBox = InfoBox;
    MapInfoBox._initialized = true;
    return MapInfoBox.InfoBox;
  };
}());
